#!/usr/bin/env python3
"""
M52: Final Composite DV - Switch Counts + PCA (No Z-Score)
==========================================================
Same pipeline as M50 but on updated dataset (Game_m52_2026-04-14.csv).
...
def create_png(avg_df, pca, scores, pct, conditions, question_df, exclusion_summary):
    ...
    fig.suptitle(
        'M52: Final Composite Dependent Variable\n'
...
def create_pdf_report(avg_df, pca, scores, pct, conditions, question_df,
    ...
    with PdfPages(output_path) as pdf:
        ...
        ax_title = axes[0]
        ax_title.axis('off')
        ax_title.text(0.5, 0.90, 'M52: Final Composite Dependent Variable',
...
def main():
    ...
    out_png = OUTPUT_DIR / 'm52_final_composite_dv.png'
    ...
    csv_path = OUTPUT_DIR / 'm52_final_composite_dv.csv'
    scores_df.to_csv(csv_path, index=False)
    print(f'Saved: {csv_path}')

    # PDF report
    pdf_path = OUTPUT_DIR / 'm52_final_composite_dv.pdf'
