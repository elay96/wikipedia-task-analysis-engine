#!/usr/bin/env python3
"""
M1: Time on Page — Threshold 20s
=================================
Exploit = stayed on page > 20s | Explore = < 20s
Output: m1_time_20s.png
"""
...
def main():
    print(f"[M1] Time threshold {THRESHOLD}s")
    trials = load_trials()
    ...
    outpath = OUTPUT_DIR / 'm1_time_20s.png'
    plt.tight_layout()
